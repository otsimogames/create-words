...
export default (() => {
    ...
    let globs = {
        js: path.join(cfg.paths.src.root, 'node_modules', 'otsimo-core-create-words', path.sep),
        ...
        settingsjson: path.join(cfg.paths.src.root, 'node_modules', 'otsimo-core-create-words', 'settings.json'),
